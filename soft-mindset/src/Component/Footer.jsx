...
const addressList = [{ iconName: 'icofont-google-map', text: 'New York, USA.', }
...
const quickList = [{ text: 'Summer Sessions', link: '#', }
    ...
    ,]
const tweetList = [{ iconName: 'icofont-twitter', desc: <p>Aminur islam <a href="#">@ShopCart Greetings!  #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</p>, }
    , { iconName: 'icofont-twitter', desc: <p>Somrat islam <a href="#">@ShopCart Hey! #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</p>, }
    ,]
                                        ...
                                        <ul className='lab-ul social-icons'>
                                            {
                                                socialList.map((val, i) =>
                                                    <li key={i}>
                                                        <a>   <i className={val.iconName}>{val.text}</i>
                                                        </a>
                                                    </li>
                                                )
                                            }
